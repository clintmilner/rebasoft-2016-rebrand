...
<!--			</style>-->
	        ...
	        foreach ( $timelines as $timeline ) {
	            ...
	            echo '<p>"';
	                echo $result;
				echo '"</p>';
				echo '<span class="date pull-right">'.$this->tweet_time( $timeline->created_at ).'</span>';
				echo '<span class="handle pull-left"><a href="http://twitter.com/rebasoft">@rebasoft</a></span>';
